...
const BlogCard = ({ blog, blogs, setBlogs }) => {
  const showImage = (img) => {
    return img
      ? `${import.meta.env.VITE_API_URL.replace('/api','')}/uploads/blogs/${img}`
      ...
      <div className="card border-0 shadow-lg">
        ...
        <div className="card-body">
          ...
          <div className="d-flex justify-content-between">
            <Link to={`/blog/${blog.id}`} className="btn btn-dark">
              Details
            </Link>
            <div>
              <button
              ...
              <Link to={`/blog/edit/${blog.id}`} className="text-dark ms-4" title="Edit blog">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
